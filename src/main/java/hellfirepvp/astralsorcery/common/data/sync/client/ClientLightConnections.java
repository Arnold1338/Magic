...
{
    private final Map<ResourceKey<Level>, Map<BlockPos, Set<BlockPos>>> clientPosBuffer;
    
    public ClientLightConnections() {
        this.clientPosBuffer = new HashMap<ResourceKey<Level>, Map<BlockPos, Set<BlockPos>>>();
    }
    
    @Nonnull
    public Map<BlockPos, Set<BlockPos>> getClientConnections(final ResourceKey<Level> dim) {
