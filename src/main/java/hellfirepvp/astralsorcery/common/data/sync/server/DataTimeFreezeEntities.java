...
{
    private final Map<ResourceKey<Level>, Set<Integer>> serverActiveEntityFreeze;
    private final Set<ResourceKey<Level>> serverSyncTypes;
    
    private DataTimeFreezeEntities(final ResourceLocation key) {
        super(key);
        this.serverActiveEntityFreeze = new HashMap<ResourceKey<Level>, Set<Integer>>();
        this.serverSyncTypes = new HashSet<ResourceKey<Level>>();
    }
    
    public void freezeEntity(final Entity e) {
        final ResourceKey<Level> dim = (ResourceKey<Level>)e.level().dimension();
    ...
    @Override
    public void clear(final ResourceKey<Level> dimType) {
    ...
    public void writeDiffDataToPacket(final CompoundTag compound) {
        final Map<ResourceKey<Level>, Set<Integer>> entities = new HashMap<ResourceKey<Level>, Set<Integer>>();
    ...
    private void writeEntityInformation(final CompoundTag out, final Map<ResourceKey<Level>, Set<Integer>> entities) {
