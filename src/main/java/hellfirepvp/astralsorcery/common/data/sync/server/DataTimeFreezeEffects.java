...
public class DataTimeFreezeEffects extends AbstractData
{
    ...
    private DataTimeFreezeEffects(final ResourceLocation key) {
        super(key);
        this.serverActiveFreezeZones = new HashMap<RegistryKey<World>, List<TimeStopEffectHelper>>();
        this.scheduledServerSyncChanges = new LinkedList<ServerSyncAction>();
    }
    
    public void addNewEffect(final RegistryKey<World> dim, final TimeStopEffectHelper effectHelper) {
    ...
    public void removeEffect(final RegistryKey<World> dim, final TimeStopEffectHelper effectHelper) {
    ...
    public void writeAllDataToPacket(final CompoundTag compound) {
        ...
        for (final RegistryKey<World> dim : this.serverActiveFreezeZones.keySet()) {
    ...
    public static class ServerSyncAction
    {
        ...
        private ServerSyncAction(final ActionType type, final RegistryKey<World> dim, final TimeStopEffectHelper involvedEffect) {
            this.type = type;
            this.dim = dim;
