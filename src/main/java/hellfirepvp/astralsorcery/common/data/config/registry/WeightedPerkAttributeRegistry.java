...
{
    public static final WeightedPerkAttributeRegistry INSTANCE;
    ...
    @Nullable
    @Override
    public PerkAttributeEntry deserialize(final String string) throws IllegalArgumentException {
        return PerkAttributeEntry.deserialize(string);
    }
    
    static {
        INSTANCE = new WeightedPerkAttributeRegistry();
    }
}
