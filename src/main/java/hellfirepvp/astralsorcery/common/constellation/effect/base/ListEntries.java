...
public class ListEntries
{
    public static class EntitySpawnEntry extends CounterEntry
    {
        ...
        public static EntitySpawnEntry createEntry(final ServerLevel world, final BlockPos pos, final SpawnReason reason) {
        ...
        public void spawn(final ServerLevel world, final SpawnReason reason) {
            if (this.type == null) {
                return;
            }
            ...
            if (e != null) {
                ...
                if (e instanceof MobEntity) {
                    ((MobEntity)e).func_213386_a((IServerWorld)world, world.func_175649_E(at), reason, (ILivingEntityData)null, (CompoundTag)null);
