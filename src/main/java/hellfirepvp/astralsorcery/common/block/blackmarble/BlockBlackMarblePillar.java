...
public class BlockBlackMarblePillar extends BlockBlackMarbleTemplate implements SimpleWaterloggedBlock
{
    ...
    public BlockBlackMarblePillar() {
        this.func_180632_j((BlockState)((BlockState)((BlockState)this.func_176194_O().func_177621_b()).setValue((Property)BlockBlackMarblePillar.PILLAR_TYPE, (Comparable)PillarType.MIDDLE)).setValue((Property)BlockBlackMarblePillar.WATERLOGGED, (Comparable)false));
    ...
    protected VoxelShape createPillarShape() {
        return Block.of(2.0, 0.0, 2.0, 14.0, 16.0, 14.0);
    }
    
    protected VoxelShape createPillarTopShape() {
        final VoxelShape column = Block.of(2.0, 0.0, 2.0, 14.0, 12.0, 14.0);
        final VoxelShape top = Block.of(0.0, 12.0, 0.0, 16.0, 16.0, 16.0);
        return VoxelUtils.combineAll(BooleanOp.field_223244_o_, column, top);
    }
    
    protected VoxelShape createPillarBottomShape() {
        final VoxelShape column = Block.of(2.0, 4.0, 2.0, 14.0, 16.0, 14.0);
        final VoxelShape bottom = Block.of(0.0, 0.0, 0.0, 16.0, 4.0, 16.0);
    ...
    public BlockState func_196271_a(final BlockState thisState, final Direction otherBlockFacing, final BlockState otherBlockState, final IWorld world, final BlockPos thisPos, final BlockPos otherBlockPos) {
        ...
        return (BlockState)this.getThisState((IBlockReader)world, thisPos).setValue((Property)BlockBlackMarblePillar.WATERLOGGED, thisState.getValue((Property)BlockBlackMarblePillar.WATERLOGGED));
    }
    ...
    public BlockState func_196258_a(final BlockItemUseContext ctx) {
        ...
        return (BlockState)this.getThisState((IBlockReader)world, blockpos).setValue((Property)BlockBlackMarblePillar.WATERLOGGED, (Comparable)(fluidState.func_206886_c() == Fluids.field_204546_a));
    }
    ...
    private BlockState getThisState(final IBlockReader world, final BlockPos pos) {
        ...
        final boolean hasDown = world.getBlockState(pos.renderItem()).getBlock() instanceof BlockBlackMarblePillar;
        if (hasUp) {
            if (hasDown) {
                return (BlockState)this.defaultBlockState().setValue((Property)BlockBlackMarblePillar.PILLAR_TYPE, (Comparable)PillarType.MIDDLE);
            }
            return (BlockState)this.defaultBlockState().setValue((Property)BlockBlackMarblePillar.PILLAR_TYPE, (Comparable)PillarType.BOTTOM);
        }
        else {
            if (hasDown) {
                return (BlockState)this.defaultBlockState().setValue((Property)BlockBlackMarblePillar.PILLAR_TYPE, (Comparable)PillarType.TOP);
            }
            return (BlockState)this.defaultBlockState().setValue((Property)BlockBlackMarblePillar.PILLAR_TYPE, (Comparable)PillarType.MIDDLE);
        }
    }
