...
public class BlockBlackMarblePillar extends BlockBlackMarbleTemplate implements IWaterLoggable
{
    ...
    private BlockState getThisState(final BlockGetter world, final BlockPos pos) {
        ...
        if (hasUp) {
            if (hasDown) {
                return (BlockState)this.func_176223_P().func_206870_a((Property)BlockBlackMarblePillar.PILLAR_TYPE, (Comparable)PillarType.MIDDLE);
            }
            return (BlockState)this.func_176223_P().func_206870_a((Property)BlockBlackMarblePillar.PILLAR_TYPE, (Comparable)PillarType.BOTTOM);
        }
        else {
            if (hasDown) {
                return (BlockState)this.func_176223_P().func_206870_a((Property)BlockBlackMarblePillar.PILLAR_TYPE, (Comparable)PillarType.TOP);
            }
            return (BlockState)this.func_176223_P().func_206870_a((Property)BlockBlackMarblePillar.PILLAR_TYPE, (Comparable)PillarType.MIDDLE);
        }
    }
    ...
    public FluidState func_204507_t(final BlockState state) {
        return state.func_177229_b((Property)BlockBlackMarblePillar.WATERLOGGED) ? Fluids.field_204546_a.func_207204_a(false) : super.func_204507_t(state);
    }
