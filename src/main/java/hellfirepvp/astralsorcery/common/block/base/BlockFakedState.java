...
public abstract class BlockFakedState extends ContainerBlock
{
    ...
    public InteractionResult func_225533_a_(final BlockState state, final World world, final BlockPos pos, final Player player, final Hand handIn, final BlockRayTraceResult hit) {
        final BlockState fakeState = this.getFakedState((IBlockReader)world, pos);
        try {
