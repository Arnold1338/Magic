...
public class BlockInfusedWoodColumn extends BlockInfusedWoodTemplate implements IWaterLoggable
{
    ...
    public VoxelShape func_220053_a(final BlockState state, final BlockGetter world, final BlockPos pos, final ISelectionContext ctx) {
        switch ((PillarType)state.func_177229_b((Property)BlockInfusedWoodColumn.PILLAR_TYPE)) {
            case TOP: {
    ...
    public BlockState func_196271_a(final BlockState thisState, final Direction otherBlockFacing, final BlockState otherBlockState, final LevelAccessor world, final BlockPos thisPos, final BlockPos otherBlockPos) {
        if (thisState.func_177229_b((Property)BlockInfusedWoodColumn.WATERLOGGED)) {
        ...
        return (BlockState)this.getThisState((BlockGetter)world, thisPos).func_206870_a((Property)BlockInfusedWoodColumn.WATERLOGGED, thisState.func_177229_b((Property)BlockInfusedWoodColumn.WATERLOGGED));
    }
    ...
    public BlockState func_196258_a(final BlockItemUseContext ctx) {
        ...
        return (BlockState)this.getThisState((BlockGetter)world, blockpos).func_206870_a((Property)BlockInfusedWoodColumn.WATERLOGGED, (Comparable)(ifluidstate.func_206886_c() == Fluids.field_204546_a));
    }
    
    private BlockState getThisState(final BlockGetter world, final BlockPos pos) {
        final boolean hasUp = world.getBlockState(pos.func_177984_a()).func_177230_c() instanceof BlockInfusedWoodColumn;
        final boolean hasDown = world.getBlockState(pos.func_177977_b()).func_177230_c() instanceof BlockInfusedWoodColumn;
        if (hasUp) {
            if (hasDown) {
                return (BlockState)this.func_176223_P().func_206870_a((Property)BlockInfusedWoodColumn.PILLAR_TYPE, (Comparable)PillarType.MIDDLE);
            }
            return (BlockState)this.func_176223_P().func_206870_a((Property)BlockInfusedWoodColumn.PILLAR_TYPE, (Comparable)PillarType.BOTTOM);
        }
        else {
            if (hasDown) {
                return (BlockState)this.func_176223_P().func_206870_a((Property)BlockInfusedWoodColumn.PILLAR_TYPE, (Comparable)PillarType.TOP);
            }
            return (BlockState)this.func_176223_P().func_206870_a((Property)BlockInfusedWoodColumn.PILLAR_TYPE, (Comparable)PillarType.MIDDLE);
        }
    }
    ...
    public FluidState func_204507_t(final BlockState state) {
        return state.func_177229_b((Property)BlockInfusedWoodColumn.WATERLOGGED) ? Fluids.field_204546_a.func_207204_a(false) : super.func_204507_t(state);
    }
