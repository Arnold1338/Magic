...
public class BlockInfusedWoodColumn extends BlockInfusedWoodTemplate implements IWaterLoggable
{
    ...
    public BlockState func_196271_a(final BlockState thisState, final Direction otherBlockFacing, final BlockState otherBlockState, final LevelAccessor world, final BlockPos thisPos, final BlockPos otherBlockPos) {
        ...
        return (BlockState)this.getThisState((IBlockReader)world, thisPos).func_206870_a((Property)BlockInfusedWoodColumn.WATERLOGGED, thisState.func_177229_b((Property)BlockInfusedWoodColumn.WATERLOGGED));
    }
