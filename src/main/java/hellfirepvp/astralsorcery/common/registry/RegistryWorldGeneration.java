...
import net.minecraft.world.level.levelgen.settings.DimensionStructuresSettings;
...
import net.minecraft.world.level.levelgen.feature.template.TagMatchRuleTest;
import net.minecraft.tags.BlockTags;
import net.minecraft.world.level.levelgen.placement.ConfiguredPlacement;
import net.minecraft.world.level.levelgen.placement.TopSolidRangeConfig;
...
import net.minecraft.world.level.levelgen.blockplacer.BlockPlacer;
import net.minecraft.world.level.levelgen.blockstateprovider.BlockStateProvider;
import net.minecraft.world.level.levelgen.feature.BlockClusterFeatureConfig;
import net.minecraft.world.level.levelgen.blockplacer.SimpleBlockPlacer;
import net.minecraft.world.level.levelgen.blockstateprovider.SimpleBlockStateProvider;
...
public class RegistryWorldGeneration
{
    ...
    public static void init() {
        ...
        WorldGenerationAS.Structures.ANCIENT_SHRINE_PIECE = registerStructurePiece(WorldGenerationAS.Structures.KEY_ANCIENT_SHRINE, (StructurePieceType)AncientShrineStructure::new);
        WorldGenerationAS.Structures.DESERT_SHRINE_PIECE = registerStructurePiece(WorldGenerationAS.Structures.KEY_DESERT_SHRINE, (StructurePieceType)DesertShrineStructure::new);
        WorldGenerationAS.Structures.SMALL_SHRINE_PIECE = registerStructurePiece(WorldGenerationAS.Structures.KEY_SMALL_SHRINE, (StructurePieceType)SmallShrineStructure::new);
        ...
        WorldGenerationAS.Features.GEN_GLOW_FLOWER = registerConfiguredFeature(WorldGenerationAS.Features.KEY_GLOW_FLOWER, GenerationStage.Decoration.VEGETAL_DECORATION, WorldGenerationAS.Config.CFG_GLOW_FLOWER, (ConfiguredFeature<?, ?>)((ConfiguredFeature)Feature.field_227247_y_.func_225566_b_((FeatureConfiguration)new BlockClusterFeatureConfig.Builder((BlockStateProvider)new SimpleBlockStateProvider(BlocksAS.GLOW_FLOWER.defaultBlockState()), (BlockPlacer)SimpleBlockPlacer.field_236447_c_).func_227315_a_(12).func_227322_d_()).func_242732_c(6)).func_227228_a_(Features.Placements.field_244000_k).func_227228_a_(Features.Placements.field_244001_l).func_227228_a_(WorldGenerationAS.Placements.WORLD_FILTER.func_227446_a_((PlacementModifier)WorldGenerationAS.Config.CFG_GLOW_FLOWER.worldFilterConfig())));
        WorldGenerationAS.Features.GEN_ROCK_CRYSTAL = registerConfiguredFeature(WorldGenerationAS.Features.KEY_ROCK_CRYSTAL, GenerationStage.Decoration.UNDERGROUND_ORES, WorldGenerationAS.Config.CFG_ROCK_CRYSTAL, (ConfiguredFeature<?, ?>)WorldGenerationAS.Features.ROCK_CRYSTAL.func_225566_b_((FeatureConfiguration)new ReplaceBlockConfig(OreFeatureConfig.FillerBlockType.field_241882_a, BlocksAS.ROCK_CRYSTAL_ORE.defaultBlockState())).func_227228_a_(Placement.field_242907_l.func_227446_a_((PlacementModifier)new TopSolidRangeConfig(5, 0, 2))).func_227228_a_((ConfiguredPlacement)WorldGenerationAS.Placements.CHANCE.withChance(0.04f)).func_227228_a_(WorldGenerationAS.Placements.WORLD_FILTER.func_227446_a_((PlacementModifier)WorldGenerationAS.Config.CFG_ROCK_CRYSTAL.worldFilterConfig())));
        WorldGenerationAS.Features.GEN_AQUAMARINE = registerConfiguredFeature(WorldGenerationAS.Features.KEY_AQUAMARINE, GenerationStage.Decoration.UNDERGROUND_ORES, WorldGenerationAS.Config.CFG_AQUAMARINE, (ConfiguredFeature<?, ?>)((ConfiguredFeature)WorldGenerationAS.Features.REPLACE_BLOCK.func_225566_b_((FeatureConfiguration)new ReplaceBlockConfig((RuleTest)new TagMatchRuleTest((ITag)BlockTags.field_203436_u), BlocksAS.AQUAMARINE_SAND_ORE.defaultBlockState())).func_227228_a_(WorldGenerationAS.Placements.RIVERBED.func_227446_a_((PlacementModifier)NoPlacementConfig.field_236556_b_)).func_242732_c(8)).func_227228_a_(WorldGenerationAS.Placements.WORLD_FILTER.func_227446_a_((PlacementModifier)WorldGenerationAS.Config.CFG_AQUAMARINE.worldFilterConfig())));
        WorldGenerationAS.Features.GEN_MARBLE = registerConfiguredFeature(WorldGenerationAS.Features.KEY_MARBLE, GenerationStage.Decoration.UNDERGROUND_ORES, WorldGenerationAS.Config.CFG_MARBLE, (ConfiguredFeature<?, ?>)((ConfiguredFeature)((ConfiguredFeature)((ConfiguredFeature)Feature.field_202290_aj.func_225566_b_((FeatureConfiguration)new OreFeatureConfig(OreFeatureConfig.FillerBlockType.field_241882_a, BlocksAS.MARBLE_RAW.defaultBlockState(), 26)).func_242733_d(96)).func_242728_a()).func_242732_c(10)).func_227228_a_(WorldGenerationAS.Placements.WORLD_FILTER.func_227446_a_((PlacementModifier)WorldGenerationAS.Config.CFG_MARBLE.worldFilterConfig())));
    }
