...
public class RegistryEntities
{
    ...
    public static void init() {
        EntityTypesAS.NOCTURNAL_SPARK = register("nocturnal_spark", (EntityType.Builder<EntityNocturnalSpark>)EntityType.Builder.func_220322_a((EntityType.IFactory)EntityNocturnalSpark.factory(), EntityClassification.MISC).func_200705_b().func_220320_c().setUpdateInterval(1).setShouldReceiveVelocityUpdates(true).setTrackingRange(32).setCustomClientFactory((spawnEntity, world) -> new EntityNocturnalSpark(world)).func_220321_a(0.1f, 0.1f));
        EntityTypesAS.ILLUMINATION_SPARK = register("illumination_spark", (EntityType.Builder<EntityIlluminationSpark>)EntityType.Builder.func_220322_a((EntityType.IFactory)EntityIlluminationSpark.factory(), EntityClassification.MISC).func_200705_b().func_220320_c().setUpdateInterval(1).setShouldReceiveVelocityUpdates(true).setTrackingRange(32).setCustomClientFactory((spawnEntity, world) -> new EntityIlluminationSpark(world)).func_220321_a(0.1f, 0.1f));
        EntityTypesAS.FLARE = register("flare", (EntityType.Builder<EntityFlare>)EntityType.Builder.func_220322_a((EntityType.IFactory)EntityFlare.factory(), EntityClassification.MISC).func_220320_c().setUpdateInterval(1).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setCustomClientFactory((spawnEntity, world) -> new EntityFlare(world)).func_220321_a(0.4f, 0.4f));
        EntityTypesAS.SPECTRAL_TOOL = register("spectral_tool", (EntityType.Builder<EntitySpectralTool>)EntityType.Builder.func_220322_a((EntityType.IFactory)EntitySpectralTool.factory(), EntityClassification.MISC).func_200705_b().func_220320_c().setUpdateInterval(1).setShouldReceiveVelocityUpdates(true).setTrackingRange(32).setCustomClientFactory((spawnEntity, world) -> new EntitySpectralTool(world)).func_220321_a(0.6f, 0.8f));
        EntityTypesAS.ITEM_HIGHLIGHT = register("item_highlighted", (EntityType.Builder<EntityItemHighlighted>)EntityType.Builder.func_220322_a((EntityType.IFactory)EntityItemHighlighted.factoryHighlighted(), EntityClassification.MISC).func_200705_b().setUpdateInterval(1).setShouldReceiveVelocityUpdates(true).setTrackingRange(16).setCustomClientFactory((spawnEntity, world) -> new EntityItemHighlighted(EntityTypesAS.ITEM_HIGHLIGHT, world)).func_220321_a(0.25f, 0.25f));
