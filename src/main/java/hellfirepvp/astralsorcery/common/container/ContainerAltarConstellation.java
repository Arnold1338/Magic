...
public class ContainerAltarConstellation extends ContainerAltarBase
{
    ...
    void bindAltarInventory(final TileInventory altarInventory) {
        ...
        this.render((Slot)new SlotItemHandler((IItemHandler)altarInventory, 1, 102, 11));
        this.render((Slot)new SlotItemHandler((IItemHandler)altarInventory, 3, 138, 11));
        this.render((Slot)new SlotItemHandler((IItemHandler)altarInventory, 4, 156, 11));
        this.render((Slot)new SlotItemHandler((IItemHandler)altarInventory, 5, 84, 29));
        for (int xx = 0; xx < 3; ++xx) {
            this.render((Slot)new SlotItemHandler((IItemHandler)altarInventory, 6 + xx, 102 + xx * 18, 29));
        }
        this.render((Slot)new SlotItemHandler((IItemHandler)altarInventory, 9, 156, 29));
        for (int xx = 0; xx < 3; ++xx) {
            this.render((Slot)new SlotItemHandler((IItemHandler)altarInventory, 11 + xx, 102 + xx * 18, 47));
        }
        this.render((Slot)new SlotItemHandler((IItemHandler)altarInventory, 15, 84, 65));
        for (int xx = 0; xx < 3; ++xx) {
            this.render((Slot)new SlotItemHandler((IItemHandler)altarInventory, 16 + xx, 102 + xx * 18, 65));
        }
        this.render((Slot)new SlotItemHandler((IItemHandler)altarInventory, 19, 156, 65));
        this.render((Slot)new SlotItemHandler((IItemHandler)altarInventory, 20, 84, 83));
        this.render((Slot)new SlotItemHandler((IItemHandler)altarInventory, 21, 102, 83));
        this.render((Slot)new SlotItemHandler((IItemHandler)altarInventory, 23, 138, 83));
