...
import hellfirepvp.astralsorcery.common.base.patreon.types.TypeStarryPlayerLayer;
import hellfirepvp.astralsorcery.common.base.patreon.PatreonEffectProvider;

public class ProviderStarryPlayerLayer implements PatreonEffectProvider<TypeStarryPlayerLayer>
{
    @Override
    public TypeStarryPlayerLayer buildEffect(final UUID playerUUID, final List<String> effectParameters) throws Exception {
