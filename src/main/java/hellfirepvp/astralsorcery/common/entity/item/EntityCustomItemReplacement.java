...
public class EntityCustomItemReplacement extends ItemEntity
{
    ...
    public EntityCustomItemReplacement(final EntityType<? extends ItemEntity> type, final Level world) {
        super((EntityType)type, world);
    }
    
    public EntityCustomItemReplacement(final Level worldIn, final double x, final double y, final double z) {
        super(worldIn, x, y, z);
    }
    
    public EntityCustomItemReplacement(final Level worldIn, final double x, final double y, final double z, final ItemStack stack) {
