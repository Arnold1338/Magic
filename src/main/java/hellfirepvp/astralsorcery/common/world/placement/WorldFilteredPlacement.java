...
public class WorldFilteredPlacement extends Placement<WorldFilterConfig>
{
    ...
    public ConfiguredPlacement<WorldFilterConfig> inWorlds(final boolean ignoreFilter, final List<ResourceKey<Level>> worlds) {
        return this.inWorlds(() -> ignoreFilter, () -> worlds);
    }
    
    public ConfiguredPlacement<WorldFilterConfig> inWorlds(final Supplier<Boolean> ignoreFilter, final Supplier<List<ResourceKey<Level>>> worlds) {
