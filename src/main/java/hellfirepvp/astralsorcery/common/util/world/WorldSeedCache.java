...
public class WorldSeedCache
{
    ...
    private static final Map<RegistryKey<World>, Long> cacheSeedLookup;
    ...
    @OnlyIn(Dist.CLIENT)
    public static void updateSeedCache(final RegistryKey<World> dim, final int session, final long seed) {
    ...
    @OnlyIn(Dist.CLIENT)
    public static Optional<Long> getSeedIfPresent(final RegistryKey<World> dim) {
        if (dim == null) {
    ...
    static {
        ...
        cacheSeedLookup = new HashMap<RegistryKey<World>, Long>();
    }
}
