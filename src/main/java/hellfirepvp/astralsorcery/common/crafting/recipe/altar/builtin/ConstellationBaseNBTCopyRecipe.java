...
public class ConstellationBaseNBTCopyRecipe extends NBTCopyRecipe
{
    ...
    public ConstellationBaseNBTCopyRecipe(final ResourceLocation recipeId, final AltarType altarType, final int duration, final int starlightRequirement, final AltarRecipeGrid recipeGrid) {
        super(recipeId, altarType, duration, starlightRequirement, recipeGrid);
        this.constellation = null;
    }
    
    public static ConstellationBaseNBTCopyRecipe convertToThis(final SimpleAltarRecipe other) {
        return new ConstellationBaseNBTCopyRecipe(other.func_199560_c(), other.getAltarType(), other.getDuration(), other.getStarlightRequirement(), other.getInputs());
    }
    ...
    public ConstellationBaseNBTCopyRecipe setConstellation(final IConstellation constellation) {
