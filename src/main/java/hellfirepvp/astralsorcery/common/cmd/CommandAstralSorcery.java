...
public class CommandAstralSorcery
{
    public static void register(final CommandDispatcher<CommandSource> dispatcher) {
        final LiteralCommandNode<CommandSource> cmdAstralSorcery = (LiteralCommandNode<CommandSource>)dispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.func_197057_a("as").then((ArgumentBuilder)CommandAttune.register())).then((ArgumentBuilder)CommandConstellation.register())).then((ArgumentBuilder)CommandExp.register())).then((ArgumentBuilder)CommandMaximizeAll.register())).then((ArgumentBuilder)CommandReset.register())).then((ArgumentBuilder)CommandProgress.register())).then((ArgumentBuilder)CommandSerialize.register()));
