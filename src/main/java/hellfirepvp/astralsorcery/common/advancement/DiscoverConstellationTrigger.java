...
public class DiscoverConstellationTrigger extends ListenerCriterionTrigger<ConstellationInstance>
{
    ...
    public DiscoverConstellationTrigger() {
        super(DiscoverConstellationTrigger.ID);
    }
    ...
    public void trigger(final ServerPlayer player, final IConstellation cst) {
    ...
    static {
        ID = new ResourceLocation("astralsorcery", "find_constellation");
    }
}
