...
public class ScreenContainerAltarRadiance extends ScreenContainerAltar<ContainerAltarTrait>
{
    ...
    protected void func_230451_b_(final PoseStack renderStack, final int mouseX, final int mouse) {
        ...
        for (int i = 0; i < 18; ++i) {
            ...
            RenderingUtils.draw(7, DefaultVertexFormats.field_227851_o_, buf -> RenderingGuiUtils.rect((IVertexBuilder)buf, renderStack, (float)(15 + x), (float)(39 + y), (float)this.func_230927_p_(), 5.0f, 5.0f).color(brightness, brightness, brightness, brightness).draw());
        }
