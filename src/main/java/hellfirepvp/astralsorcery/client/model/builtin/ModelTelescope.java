...
public class ModelTelescope extends CustomModel
{
    ...
    public ModelTelescope() {
        ...
        (this.leg = new ModelPart((Model)this, 56, 0)).func_78793_a(0.0f, 8.0f, 0.0f);
        this.leg.func_228301_a_(-1.0f, -10.0f, -1.0f, 2.0f, 36.0f, 2.0f, 0.0f);
        (this.mountpiece_1 = new ModelPart((Model)this, 32, 0)).func_78793_a(0.0f, 0.0f, -1.0f);
        this.mountpiece_1.func_228301_a_(-2.0f, 20.0f, -1.0f, 4.0f, 6.0f, 4.0f, 0.0f);
        (this.aperture_1 = new ModelPart((Model)this, 28, 28)).func_78793_a(0.0f, 0.0f, 0.0f);
        this.aperture_1.func_228301_a_(-1.0f, -3.0f, -6.0f, 6.0f, 6.0f, 2.0f, 0.0f);
        (this.aperture = new ModelPart((Model)this, 0, 28)).func_78793_a(0.0f, 0.0f, 0.0f);
        this.aperture.func_228301_a_(-1.0f, -3.0f, -16.0f, 6.0f, 6.0f, 8.0f, 0.0f);
        (this.extension = new ModelPart((Model)this, 0, 12)).func_78793_a(0.0f, 0.0f, 0.0f);
        this.extension.func_228301_a_(-2.0f, -6.0f, 6.0f, 2.0f, 6.0f, 2.0f, 0.0f);
        (this.detail = new ModelPart((Model)this, 0, 8)).func_78793_a(0.0f, 0.0f, 0.0f);
        this.detail.func_228301_a_(1.0f, -1.0f, 10.0f, 2.0f, 2.0f, 2.0f, 0.0f);
        (this.opticalTube = new ModelPart((Model)this, 0, 0)).func_78793_a(1.0f, -3.0f, 0.0f);
        ...
        (this.mountpiece = new ModelPart((Model)this, 0, 0)).func_78793_a(0.0f, -2.0f, 0.0f);
