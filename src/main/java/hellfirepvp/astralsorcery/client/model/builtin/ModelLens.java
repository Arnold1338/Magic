...
public class ModelLens extends CustomModel
{
    ...
    public ModelLens() {
        ...
        (this.base = new ModelPart((Model)this, 0, 13)).func_78793_a(0.0f, 16.0f, 0.0f);
        this.base.func_228301_a_(-6.0f, 4.0f, -6.0f, 12.0f, 2.0f, 12.0f, 0.0f);
        (this.frame1 = new ModelPart((Model)this, 0, 13)).func_78793_a(0.0f, 16.0f, 0.0f);
        this.frame1.func_228301_a_(-8.0f, -4.0f, -1.0f, 2.0f, 10.0f, 2.0f, 0.0f);
        this.frame2 = new ModelPart((Model)this, 0, 13);
        ...
        (this.lens = new ModelPart((Model)this, 0, 0)).func_78793_a(0.0f, 14.0f, 0.0f);
