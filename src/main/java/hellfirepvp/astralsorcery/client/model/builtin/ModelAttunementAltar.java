...
public class ModelAttunementAltar extends CustomModel
{
    ...
    public void renderHovering(final PoseStack matrixStackIn, final IVertexBuilder bufferIn, final int packedLightIn, final int packedOverlayIn, final float red, final float green, final float blue, final float alpha, final float offX, final float offZ, final float perc) {
