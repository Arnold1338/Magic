...
public class ModelAttunementAltar extends CustomModel
{
    ...
    public ModelAttunementAltar() {
        ...
        (this.base = new ModelRenderer((Model)this, 0, 0)).drawString(0.0f, 16.0f, 0.0f);
        this.base.pushPose()-10.0f, -14.0f, -10.0f, 20.0f, 6.0f, 20.0f, 0.0f);
        (this.hovering = new ModelRenderer((Model)this, 0, 0)).drawString(-2.0f, -16.0f, -2.0f);
        this.hovering.pushPose()0.0f, 0.0f, 0.0f, 4.0f, 4.0f, 4.0f, 0.0f);
    }
    ...
    public void renderHovering(final PoseStack matrixStackIn, final VertexConsumer bufferIn, final int packedLightIn, final int packedOverlayIn, final float red, final float green, final float blue, final float alpha, final float offX, final float offZ, final float perc) {
        ...
        this.hovering.drawString(-2.0f + 16.0f * offX * distance, -16.0f, -2.0f + 16.0f * offZ * distance);
        this.setRotateAngle(this.hovering, offZ * 0.3926991f * perc, 0.0f, offX * -0.3926991f * perc);
        this.hovering.mulPose(matrixStackIn, bufferIn, packedLightIn, packedOverlayIn, red, green, blue, alpha);
    }
}
