...
public class AstralAdvancementProvider extends AdvancementProvider
{
    ...
    private void registerAdvancements(final Consumer<Advancement> registrar) {
        final Advancement root = Advancement.Builder.func_200278_a().func_203902_a((ItemLike)ItemsAS.TOME, (Component)this.title("root"), (Component)this.description("root"), AstralSorcery.key("textures/block/black_marble_raw.png"), FrameType.TASK, false, false, false).func_200275_a("astralsorcery_present", (ICriterionInstance)new TickTrigger.Instance(EntityPredicate.AndPredicate.field_234582_a_)).func_203904_a((Consumer)registrar, AstralSorcery.key("root").toString());
        final Advancement foundRockCrystals = Advancement.Builder.func_200278_a().func_203905_a(root).func_203902_a((ItemLike)ItemsAS.ROCK_CRYSTAL, (Component)this.title("rock_crystals"), (Component)this.description("rock_crystals"), (ResourceLocation)null, FrameType.TASK, true, true, false).func_200275_a("rock_crystal_in_inventory", (ICriterionInstance)InventoryChangeTrigger.Instance.func_203922_a(new ItemLike[] { (ItemLike)ItemsAS.ROCK_CRYSTAL })).func_203904_a((Consumer)registrar, AstralSorcery.key("rock_crystals").toString());
        final Advancement foundCelestialCrystals = Advancement.Builder.func_200278_a().func_203905_a(foundRockCrystals).func_203902_a((ItemLike)ItemsAS.CELESTIAL_CRYSTAL, (Component)this.title("celestial_crystals"), (Component)this.description("celestial_crystals"), (ResourceLocation)null, FrameType.TASK, true, true, false).func_200275_a("celestial_crystal_in_inventory", (ICriterionInstance)InventoryChangeTrigger.Instance.func_203922_a(new ItemLike[] { (ItemLike)ItemsAS.CELESTIAL_CRYSTAL })).func_203904_a((Consumer)registrar, AstralSorcery.key("celestial_crystals").toString());
        final Advancement craftAltarT2 = Advancement.Builder.func_200278_a().func_203905_a(foundRockCrystals).func_203902_a((ItemLike)BlocksAS.ALTAR_ATTUNEMENT, (Component)this.title("craft_t2_altar"), (Component)this.description("craft_t2_altar"), (ResourceLocation)null, FrameType.TASK, true, true, false).func_200275_a("altar_craft_t2_altar", (ICriterionInstance)AltarRecipeInstance.withOutput((ItemLike)BlocksAS.ALTAR_ATTUNEMENT)).func_203904_a((Consumer)registrar, AstralSorcery.key("craft_t2_altar").toString());
        final Advancement craftAltarT3 = Advancement.Builder.func_200278_a().func_203905_a(craftAltarT2).func_203902_a((ItemLike)BlocksAS.ALTAR_CONSTELLATION, (Component)this.title("craft_t3_altar"), (Component)this.description("craft_t3_altar"), (ResourceLocation)null, FrameType.TASK, true, true, false).func_200275_a("altar_craft_t3_altar", (ICriterionInstance)AltarRecipeInstance.withOutput((ItemLike)BlocksAS.ALTAR_CONSTELLATION)).func_203904_a((Consumer)registrar, AstralSorcery.key("craft_t3_altar").toString());
        final Advancement craftAltarT4 = Advancement.Builder.func_200278_a().func_203905_a(craftAltarT3).func_203902_a((ItemLike)BlocksAS.ALTAR_CONSTELLATION, (Component)this.title("craft_t4_altar"), (Component)this.description("craft_t4_altar"), (ResourceLocation)null, FrameType.CHALLENGE, true, true, false).func_200275_a("altar_craft_t3_altar", (ICriterionInstance)AltarRecipeInstance.withOutput((ItemLike)BlocksAS.ALTAR_RADIANCE)).func_203904_a((Consumer)registrar, AstralSorcery.key("craft_t4_altar").toString());
        final Advancement findAnyConstellation = Advancement.Builder.func_200278_a().func_203905_a(root).func_203902_a((ItemLike)BlocksAS.TELESCOPE, (Component)this.title("find_constellation"), (Component)this.description("find_constellation"), (ResourceLocation)null, FrameType.TASK, true, true, false).func_200275_a("any_constellation_discovered", (ICriterionInstance)ConstellationInstance.any(DiscoverConstellationTrigger.ID)).func_203904_a((Consumer)registrar, AstralSorcery.key("find_constellation").toString());
        final Advancement findWeakConstellation = Advancement.Builder.func_200278_a().func_203905_a(findAnyConstellation).func_203902_a((ItemLike)BlocksAS.TELESCOPE, (Component)this.title("find_weak_constellation"), (Component)this.description("find_weak_constellation"), (ResourceLocation)null, FrameType.TASK, true, true, false).func_200275_a("weak_constellation_discovered", (ICriterionInstance)ConstellationInstance.anyWeak(DiscoverConstellationTrigger.ID)).func_203904_a((Consumer)registrar, AstralSorcery.key("find_weak_constellation").toString());
        final Advancement findMinorConstellation = Advancement.Builder.func_200278_a().func_203905_a(findWeakConstellation).func_203902_a((ItemLike)BlocksAS.OBSERVATORY, (Component)this.title("find_minor_constellation"), (Component)this.description("find_minor_constellation"), (ResourceLocation)null, FrameType.TASK, true, true, false).func_200275_a("minor_constellation_discovered", (ICriterionInstance)ConstellationInstance.anyMinor(DiscoverConstellationTrigger.ID)).func_203904_a((Consumer)registrar, AstralSorcery.key("find_minor_constellation").toString());
        final Advancement attuneSelf = Advancement.Builder.func_200278_a().func_203905_a(findAnyConstellation).func_203902_a((ItemLike)BlocksAS.ATTUNEMENT_ALTAR, (Component)this.title("attune_self"), (Component)this.description("attune_self"), (ResourceLocation)null, FrameType.TASK, true, true, false).func_200275_a("attune_self", (ICriterionInstance)ConstellationInstance.any(AttuneSelfTrigger.ID)).func_203904_a((Consumer)registrar, AstralSorcery.key("attune_self").toString());
        final Advancement attuneCrystal = Advancement.Builder.func_200278_a().func_203905_a(attuneSelf).func_203902_a((ItemLike)BlocksAS.RITUAL_PEDESTAL, (Component)this.title("attune_crystal"), (Component)this.description("attune_crystal"), (ResourceLocation)null, FrameType.TASK, true, true, false).func_200275_a("attune_crystal", (ICriterionInstance)ConstellationInstance.anyWeak(AttuneCrystalTrigger.ID)).func_203904_a((Consumer)registrar, AstralSorcery.key("attune_crystal").toString());
        final Advancement attuneCrystalTrait = Advancement.Builder.func_200278_a().func_203905_a(attuneCrystal).func_203902_a((ItemLike)BlocksAS.RITUAL_PEDESTAL, (Component)this.title("attune_trait"), (Component)this.description("attune_trait"), (ResourceLocation)null, FrameType.TASK, true, true, false).func_200275_a("attune_trait", (ICriterionInstance)ConstellationInstance.anyMinor(AttuneCrystalTrigger.ID)).func_203904_a((Consumer)registrar, AstralSorcery.key("attune_trait").toString());
        final Advancement perkLevelSmall = Advancement.Builder.func_200278_a().func_203905_a(attuneSelf).func_203902_a((ItemLike)BlocksAS.SPECTRAL_RELAY, (Component)this.title("perk_level_small"), (Component)this.description("perk_level_small"), (ResourceLocation)null, FrameType.TASK, true, true, false).func_200275_a("gain_perk_level_small", (ICriterionInstance)PerkLevelInstance.reachLevel(10)).func_203904_a((Consumer)registrar, AstralSorcery.key("perk_level_small").toString());
        final Advancement perkLevelMedium = Advancement.Builder.func_200278_a().func_203905_a(perkLevelSmall).func_203902_a((ItemLike)BlocksAS.SPECTRAL_RELAY, (Component)this.title("perk_level_medium"), (Component)this.description("perk_level_medium"), (ResourceLocation)null, FrameType.TASK, true, true, false).func_200275_a("gain_perk_level_medium", (ICriterionInstance)PerkLevelInstance.reachLevel(25)).func_203904_a((Consumer)registrar, AstralSorcery.key("perk_level_medium").toString());
        final Advancement perkLevelLarge = Advancement.Builder.func_200278_a().func_203905_a(perkLevelMedium).func_203902_a((ItemLike)BlocksAS.SPECTRAL_RELAY, (Component)this.title("perk_level_large"), (Component)this.description("perk_level_large"), (ResourceLocation)null, FrameType.CHALLENGE, true, true, false).func_200275_a("gain_perk_level_large", (ICriterionInstance)PerkLevelInstance.reachLevel(40)).func_203904_a((Consumer)registrar, AstralSorcery.key("perk_level_large").toString());
    }
